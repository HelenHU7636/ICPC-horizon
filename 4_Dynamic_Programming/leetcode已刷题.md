...
| 746 | [min-cost-climbing-stairs](https://leetcode.cn/problems/min-cost-climbing-stairs/) | ✅ | 1. Memoization✅<br>2. DP✅<br>3. Space Optimization | / |
| 198 | [house-robber](https://leetcode.cn/problems/house-robber/) | ✅ | 1. DP 数组✅ <br>2. 只用 $O(1)$ 空间存放有限个变量记录最近状态✅ | 边界情况处理，如只有一个数 |
